...
@section ('content')
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
				...
				Hi,{{$cityadmin->cityadmin_name}}. <small>{{ __('messages.heres whats happening with your store today.')}}</small>
			</h1>
          </div>
                        ...
                        <div class="card-body position-relative">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="d-flex">
                                        <div class="mr-auto">
                                            <h5 class="text-white-transparent-8 mb-3">{{ __('messages.Total Earning')}}</h5>
                                            <h3 class="text-white mt-n1 mb-1">{{$currency->currency_sign}}{{$total_cash}}</h3>
                                            <p class="mb-1 text-white-transparent-6 text-truncate">
                                                 <b></b>{{ __('messages.here is the total earning by all the vendors')}}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6 col-lg-5">
                                            ...
                                            <div class="mt-1">
                                                <div>T{{ __('messages.Total Sales')}}</div>
                                        ...
                                        <div class="col-6 col-lg-5">
                                            ...
                                            <div class="mt-1">
                                                <div>{{ __('messages.Referral Sales')}}</div>
                                    ...
                                    <div class="mt-3 mb-2">
                                        <a href="#" class="btn btn-yellow btn-rounded btn-sm pl-5 pr-5 pt-2 pb-2 fs-14px font-weight-600"><i class="fa fa-wallet mr-2 ml-n2"></i>{{ __('messages.Download_Report')}}</a>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-teal" style="min-height: 202px;">
                                ...
                                <!-- BEGIN card-body -->
                                <div class="card-body position-relative">
                                    <h5 class="text-white-transparent-8 mb-3 fs-16px">{{ __('messages.Vendor')}}</h5>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-indigo" style="min-height: 202px;">
                                ...
                                <div class="card-body position-relative">
                                    ...
                                    <div class="text-white-transparent-8 mb-4"></i>{{ __('messages.here_is_the_count')}} <br />{{ __('messages.Delivery_Boys')}}</div>
                ...
                <div class="col-xl-6">
                     ...
                     <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-2">
                                <div class="flex-grow-1">
                                    <h5 class="mb-1">{{ __('messages.Today_orders')}}</h5>
                                    <div class="fs-13px">{{ __('messages.Check all store Todays Order')}}</div>
                                </div>
                            ...
                            <div class="table-responsive mb-n2">
                                <table class="table table-borderless mb-0">
                                    <thead>
                                        <tr class="text-dark">
                                            <th class="pl-0">{{ __('messages.serial no')}}</th>
                                            <th>{{ __('messages.Cart_Id')}}</th>
                                            <th class="text-center">{{ __('messages.Status')}}</th>
                                            <th class="text-right pr-0">{{ __('messages.Amount')}}</th>
                                            <th class="text-right pr-0">{{ __('messages.Vendor Name')}}</th>
                      ...
                      @else
                        <tr>
                          <td colspan="5">{{ __('messages.No_data_found')}}</td>
                        </tr>
                      @endif
                                    </tbody>
                                </table>
