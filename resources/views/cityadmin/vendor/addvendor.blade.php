...
<div class="content-wrapper">
		  ...
		  <div class="col-md-2">
            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">{{ __('messages.Vendor')}}</h4>
                   @if (count($errors) > 0)
                      @if($errors->any())
             ...
             <!--       </div>-->
                       ...
                       <div class="form-group">
                    <label for="exampleFormControlSelect3">{{ __('messages.Vendor category')}}</label>
                    ...
                    <div class="form-group">
                      <label for="exampleInputName1">{{ __('messages.Vendor Name')}}</label>
                      <input type="text" class="form-control" id="exampleInputName1" name="vendor_name" placeholder="{{ __('messages.Vendor Name')}}">
                    </div>
                         @if($mapset->mapbox == 0 && $mapset->google_map == 1)
                     <div class="form-group">
                      <label for="autocomplete">{{ __('messages.Address')}}</label>
                      <input type="text" class="form-control" id="autocomplete" name="vendor_address" placeholder="{{ __('messages.Address')}}">
                   ...
                   <div class="form-group">
                      ...
                      <div class="autocomplete" style="width:100%;">
                           <input id="lng" type="hidden" name="lng">
                            ...
                            <input id="myInput" type="text" name="vendor_address" placeholder="{{ __('messages.Address')}}">
                     ...
                     <div class="form-group">
                      <label>{{ __('messages.Vendor Image')}}</label>  
                      ...
                      <div class="form-group">
                      <label for="exampleInputName1">{{ __('messages.owner name')}}</label>
                      <input type="text" class="form-control" id="exampleInputName1" name="owner_name" placeholder="{{ __('messages.owner name')}}">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">{{ __('messages.Opening Time')}}</label>
                      <input type="time" class="form-control" name="opening_time">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">{{ __('messages.Closing Time')}}</label>
                      <input type="time" class="form-control" name="closing_time">
                    </div>
                   
                      <div class="form-group">
                      <label for="exampleInputName1">{{ __('messages.Vendor Email')}}</label>
                      <input type="text" class="form-control" id="exampleInputName1" name="vendor_email" placeholder="{{ __('messages.Vendor Email')}}">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputName1">{{ __('messages.Vendor Mobile')}}</label>
                      <input type="number" class="form-control" id="exampleInputName1" name="vendor_phone" placeholder="{{ __('messages.Vendor Mobile')}}">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">{{ __('messages.Comission')}}</label>
                      <input type="text" class="form-control" id="exampleInputName1" name="comission" placeholder="Enter Comission in Percentage">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">{{ __('messages.delivery range')}}</label>
                      <input type="number" class="form-control" id="exampleInputName1" name="range" placeholder="{{ __('messages.how many kilometer you have to delivered')}}">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputName1">{{ __('messages.password')}}</label>
                      <input type="text" class="form-control" id="exampleInputName1" name="password1" placeholder="{{ __('messages.password')}}">
                    </div>
                    
                     <div class="form-group">
                      <label for="exampleInputName1">{{ __('messages.Confirm_Password')}}</label>
                      <input type="text" class="form-control" id="exampleInputName1" name="password2" placeholder="{{ __('messages.Confirm_Password')}}">
                    </div>
                    <button type="submit" class="btn btn-success mr-2">{{ __('messages.Submit')}}</button>
                    <!--
                    <button class="btn btn-light">Cancel</button>
                    -->
                     <a href="{{route('vendor')}}" class="btn btn-light">{{ __('messages.Cancel')}}</a>
                  </form>
                </div>
              </div>
            </div>
