                    ...
                    <table class="table table-bordered" id="example1" width="100%" cellspacing="0">
                      ...
                      @if(count($inventory)>0)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$inventorys->user_id}}</td>
                                        <td>{{$inventorys->product_name}}</td>
                                        <td>{{$inventorys->delivery_boy_name}}</td>
                                	...
                                	<div class="modal-dialog" role="document">
                                		<div class="modal-content">
                                			...
                                			<!--//form-->
                                			<form action="{{route('paycustomer')}}" method="post">   
                                			{{csrf_field()}}
                                			<div class="modal-body">
                                                <div class="form-group">
                                                  <label for="exampleInputName1">Pay<sup>*</sup></label>
                                                  <input type="text" class="form-control" id="exampleInputName1" name="pay" value="{{$inventorys->price}}">
