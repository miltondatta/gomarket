                ...
                <div class="card-body">
                  <h4 class="card-title">Update product</h4>
                   @if (count($errors) > 0)
                      ...
                      @endif
                  @endif
                  <form class="forms-sample" action="{{route('cityadminupdate-product',$product->product_id)}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                    ...
                    -->
                     <a href="{{route('cityadminproduct')}}" class="btn btn-light">Cancel</a>
                  </form>
                </div>
              </div>
            </div>
