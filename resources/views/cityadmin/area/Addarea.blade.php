...
<div class="content-wrapper">
		  ...
		  <div class="col-md-2">
            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">{{ __('messages.Add_Area')}}</h4>
                   @if (count($errors) > 0)
                      @if($errors->any())
                  ...
                  <form class="forms-sample" action="{{route('AddNewarea')}}" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="autocomplete" name="area_name" placeholder="{{ __('messages.Add_Area')}}">
                   ...
                   <div class="form-group">
                      ...
                      <div class="autocomplete" style="width:100%;">
                           <input id="lng" type="hidden" name="lng">
                            ...
                            <input id="myInput" type="text" name="area_name" placeholder="{{ __('messages.Select_Area')}}">
