        ...
        <table class="table table-bordered" id="example8" width="100%" cellspacing="0">
          ...
          @if(count($product)>0)
                        ...
                        <tr>
                            ...
                            <td align="center" class="image-hover"><img src="{{url($products->varient_image)}}" style="width: 21px;"></td>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="{{route('deleteproductvariant',$products->varient_id)}}" class="btn btn-primary">{{ __('messages.Delete')}}</a>
			</div>
		</div>
	</div>
</div>
