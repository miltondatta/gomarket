  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      ...
      @if (count($errors) > 0)
                  ...
                  @endif
              @endif
        <a class="btn btn-success m-auto" style="float: right;" href="{{route('resturantAdddelivery_boy')}}">{{ __('messages.Add')}}</a>
    </div>
    <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($delivery_boys->is_confirmed==0)
                                    <a href="{{route('resturantconfirmdeliverystatus',[$delivery_boys->delivery_boy_id,'1'])}}" class="btn btn-info" style="color: #fff;">Yes</a>
                                    <a href="{{route('resturantconfirmdeliverystatus',[$delivery_boys->delivery_boy_id,'2'])}}" class="btn btn-danger" style="color: #fff;">No</a>
                            ...
                            <td>
                               <a href="{{route('resturantEditdelivery_boy',$delivery_boys->delivery_boy_id)}}" style="width: 28px; padding-left: 6px;" class="btn btn-info"  style="width: 10px;padding-left: 9px;" style="color: #fff;"><i class="fa fa-edit" style="width: 10px;"></i></a>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="{{route('resturantdeletedelivery_boy', $delivery_boys->delivery_boy_id)}}" class="btn btn-primary">{{ __('messages.Delete')}}</a>
			</div>
		</div>
	</div>
</div>
