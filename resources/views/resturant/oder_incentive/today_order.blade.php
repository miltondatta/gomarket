                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered" id="example2" width="100%" cellspacing="0">
                      <thead>
                        ...
                        <th>{{ __('messages.Price Without Delivery')}}</th>
...
<div class="modal fade" id="exampleModal1{{$todayorders->order_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="container">
                        ...
                        <td colspan="3">
                            <table class="table">
                                <tr>
                                    ...
                                    <strong> {{ __('messages.Order_Id')}} : </strong> {{$todayorders->cart_id}}
                                    <br />

                                    <strong>  {{ __('messages.Delivery_Date')}} : </strong>{{$todayorders->delivery_date}}
                                    <br />
                                    <strong>  {{ __('messages.Time_Slot')}} : </strong>{{$todayorders->time_slot}}
                                    <br />
                                    </td>
                                    <td  style="width:50%" align="right">
                                        <strong> {{ __('messages.Delivery_Details')}} </strong><br />
                                        <strong>{{ __('messages.Customer_name')}} : </strong>{{$todayorders->user_name}}<br/>
                                        <strong>{{ __('messages.Contact')}} : </strong>{{$todayorders->user_number}}<br/> 
                                        <strong>{{ __('messages.Address')}} : </strong> {{$todayorders->address}}<br />
                                     </td>
      ...
      <button id="btnPrint" type="button" class="btn btn-default">{{ __('messages.Print')}}</button>
      </div>
    </div>
