              ...
              @endif
				<form class="user" method="post" action="{{route('check-admin-login')}}">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control form-control-lg fs-15px" value="" name="admin_email" placeholder="username@address.com" />
					</div>
					<div class="form-group">
						<div class="d-flex">
						...
						<input type="password" class="form-control form-control-lg fs-15px" value="" name="admin_pass" placeholder="Enter your password" />
					</div>
					<div class="form-group">
