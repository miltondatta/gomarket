...
@section ('content')
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
				...
				Hi, {{$admin->admin_name}}. <small>{{ __('messages.happening')}}</small>
			</h1>
          </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        <div class="col-6 col-lg-5">
                                            ...
                                            <div class="mt-1">
                                                <div>{{ __('messages.Total Sales')}}</div>
                                    ...
                                    <div class="mt-3 mb-2">
                                        @if($total_earnings>0) 
                                            <a href="{{ route('adminallexcelgenerator') }}" class="btn btn-yellow btn-rounded btn-sm pl-5 pr-5 pt-2 pb-2 fs-14px font-weight-600" target="_self"><i class="fa fa-wallet mr-2 ml-n2"></i>{{ __('messages.Download_Report')}}</a>
                                        @endif
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-indigo" style="min-height: 202px;">
                                ...
                                <!-- BEGIN card-body -->
                                <div class="card-body position-relative">
                                    <h5 class="text-white-transparent-8 mb-3 fs-16px">{{ __('messages.city admin')}}</h5>
                                    <h3 class="text-white mt-n1">{{$ongoing}}</h3>
                                    <div class="progress bg-black-transparent-5 mb-2" style="height: 6px">
                                        <div class="progrss-bar progress-bar-striped bg-white" style="width: 80%"></div>
                                    </div>
                                    <div class="text-white-transparent-8 mb-4"></i>{{ __('messages.here_is_the_count')}}<br />{{ __('messages.city admin')}}</div>
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                     ...
                     <div class="card">
                      ...
                      @else
                        <tr>
                          <td colspan="4">{{ __('messages.No_data_found')}}</td>
                        </tr>
                      @endif
                                    </tbody>
                                </table>
