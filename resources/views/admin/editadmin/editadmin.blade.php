								...
								<div id="privacyAndSecurity" class="mb-5">
									...
									<div class="card">
										...
										<form action="{{route('update_fcm')}}" method="post">   
                                			...
                                			<div class="form-group list-group-item d-flex align-items-center">
                                              <label for="exampleInputName1">{{ __('messages.Vendor FCM Server Key')}}<sup>*</sup></label>
            ...
            <div class="card-body">
              ...
              <h5 class="header-title">{{ __('messages.Choose One') }} {{ __('messages.Payment Gateways') }}</h5>
                        ...
                        <div class="row">
                          <div class="col-md-8">
                            <div class="form-group">
                             ...
                             <h4><i class="far fa-credit-card fa-fw"></i>Option to enable COD/online Payment</h4>
                            <div>
                                <form class="forms-sample" action="{{route('update_payment_mode')}}" method="post" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                      <input type="checkbox" id="scales" name="cod" value="on"
                                              <?php if($pay->cod_status=="on"){?> checked <?php } ?> >
                                      <label>COD</label>
                                      
                                    </div>
                                    
                                    <div>
                                      <input type="checkbox" id="horns" name="online_payment" value="on" <?php if($pay->payment_status=="on"){?> checked <?php } ?>>
               ...
               <form method="post" class="appsvan-submit params-panel" autocomplete="off" action="{{route('updategateway')}}" enctype="multipart/form-data">
                ...
                <!---->
                <br>@endif
                @if(get_option('paymongo_active')=='Yes')
							...
							<div class="col-xl-3">
								...
								<nav id="sidebar-bootstrap" class="navbar navbar-sticky d-none d-xl-block">
									<nav class="nav">
									  ...
									  <a class="nav-link" href="#languages" data-toggle="scroll-to"> {{ __('messages.Firebase otp')}}</a>
									  <a class="nav-link" href="#payment" data-toggle="scroll-to"> {{ __('messages.Payment Gateways')}}</a>
									</nav>
								</nav>
