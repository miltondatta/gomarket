                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{route('AddNewcityadmin')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="cityadmin_name" placeholder="{{ __('messages.Admin Name')}}">
                    </div>
                    @if($mapset->mapbox == 0 && $mapset->google_map == 1)
                     <div class="form-group">
                      <label for="autocomplete">{{ __('messages.Address')}}</label>
                      <input type="text" class="form-control" id="autocomplete" name="cityadmin_address" placeholder="{{ __('messages.Address')}}">
                   ...
                   <div class="form-group">
                      ...
                      <div class="autocomplete" style="width:100%;">
                           <input id="lng" type="hidden" name="lng">
                            ...
                            <input id="myInput" type="text" name="cityadmin_address" placeholder="{{ __('messages.Address')}}">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="cityadmin_email" placeholder="{{ __('messages.Cityadmin Email')}}">
                    </div>
                     <div class="form-group">
                      <label for="exampleInputName1">{{ __('messages.Cityadmin Phone')}}</label>
                      <input type="text" class="form-control" id="exampleInputName1" name="cityadmin_phone" placeholder={{ __('messages.Cityadmin Phone')}}">
                    </div>
                     <div class="form-group">
