...
<html lang="en">
   ...
   <body>
   @include("web.restaurantsubheader")
   <br>
      <style type="text/css">
                  ...
                  <div class="card-body checkout_cardbody">
                     <div class="row" style="margin-top: 20px;">
                      ...
                      <select class="form-control" name="addressselection" id="addressselection" onchange="selectaddress(this)">
                          ...
                          <option value="{{$addressdetailsdatanew->address_id}}" >{{$addressdetailsdatanew->address}}</option>
                          <?php }?>
                      </select>
                        </div>
                        </div>
                     ...
                     <div class="modal-content">
                        ...
                        <div class="modal-body" style="padding: 30px 20px 20px 40px;">
                           <center>
                              ...
                              <p style="font-size: 18px;font-weight: 500;">{{ __('messages.Order_Id')}} :</p>
                              <p style="font-size: 18px;margin-top: -15px;" id="orderid">150340001178606</p>
                              <a href="{{ route('pharmacyindex') }}"><button style="background-color: #1461C9;color: white;height: 47px;width: 64%;border-radius: 25px;font-size: 17px;margin-top: 13px;border: 0;font-weight: 500;margin-bottom: 20px;" class="shadow">Continue Shopping</button></a>
                           </center>
                        </div>
                     </div>
                  </div>
            ...
            <div class="col-xl-4">
               ...
               <div class="card shadow checkout_card">
                  ...
                  <?php if(isset($cartitem)){ $sum=0; foreach($cartitem as $cartitemkey => $cartitem) { 
                        $productdetails = DB::table('resturant_product')->where(array('product_id' => $cartitem->product_id))->first();
                  ...
                  <div class="row" style="min-width: 100%;margin-left: 0px;padding-top: 14px;">
                     <div class="col-sm-3" style="max-width: 20%;border-left: 10px solid #41CF2E;"><img src="{{ url(''.$finalimage)}}" style="height: 60px;width: 80px;"></div>
               ...
               <div class="card shadow checkout_card">
                  ...
                  <input type="hidden"  id="finalamount" name="finalamount" value="<?php  echo $sum + $deliverycharges; ?>">
                   ...
                   <input type="hidden" name="uitype" id="uitype" value="3">
