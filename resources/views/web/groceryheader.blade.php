         ...
         <ul class="navbar-nav ml-auto" style="margin-right: 55px;">
            <li class="nav-item" >
               <div class="btn-group btngroup_butt" role="group" aria-label="Basic example">
                  ...
                  <form method="POST" action="{{route('groceryshoplistSearch')}}">
                    {{csrf_field()}}
            ...
            <img src="{{ url('frontassets/image/user.png') }}" height="20"><br>
               ...
               <div class="dropdown-menu sm-menu shadow " id="navbardrop" style="position: fixed;top: 89px;left: 74%;">
                  <a class="dropdown-item" href="{{ route('groceryprofile') }}"><i class="fas fa-user"></i> My Profile</a>
                  <a class="dropdown-item" href="{{ route('groceryorder') }}"><i class="fas fa-align-justify"></i> My Order</a>
            ...
            <div class="table-responsive" style="overflow-x: hidden;">
                ...
                <table class="table table-striped" >
                  ...
                  foreach($cartdata as $cartkey => $cartdata) {
                    ...
                    ?>
                        <tr>
                            <td style="width: 10%;"><img src="@if(isset($product->product_image)){{ url(''.$product->product_image)}}@endif" style="height: 45px;width: 70px;" /> </td>
