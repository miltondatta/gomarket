...
<div class="fixed-top header_fixeder">
   ...
   <div class="navbar navbar-expand-lg navtwo_back">
      ...
      <center ><a class="navbar-brand navtwo_anchor" href="{{url('parcalindex')}}"><img src="{{ url(''.$vendorgrocerycat->category_image)}}" class="navtwo_animg"><br>{{$vendorgrocerycat->category_name}}</a></center>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left: 124px;margin-bottom: -2px;">
         ...
         <ul class="navbar-nav ml-auto" style="margin-right: 55px;">
            ...
            <div class="btn-group btngroup_butt" role="group" aria-label="Basic example">
                  ...
                  <form method="POST" action="{{route('parcalshoplistSearch')}}">
                    {{csrf_field()}}
            ...
            <li class="nav-item login_li65">
               <center><a class="nav-link link_item19" style="line-height: 18px;" href="{{ route('parcelweblogin')}}" ><img src="{{ url('frontassets/image/user.png') }}" height="20"><br>LOGIN</a></center>
            </li>
            <li class="nav-item login_li65">
               <center><a class="nav-link link_item19" style="line-height: 18px;" href="{{ route('parcelwebsignup')}}"><img src="{{ url('frontassets/image/user.png') }}" height="20"><br>SIGNUP</a></center>
            </li>
            @else
            ...
            <li class="nav-item login_li65"><center><a class="nav-link link_item19" style="line-height: 18px;" data-target="#navbardrop" data-toggle="dropdown" ><img src="{{ url('frontassets/image/user.png') }}" height="20"><br>{{ session('name') }}</a></center>
                <div class="dropdown-menu sm-menu shadow " id="navbardrop" style="position: fixed;top: 89px;left: 74%;">
                  <a class="dropdown-item" href="{{ route('parcelprofile') }}"><i class="fas fa-user"></i> My Profile</a>
                  <a class="dropdown-item" href="{{ route('parcelorder') }}"><i class="fas fa-align-justify"></i> My Order</a>
