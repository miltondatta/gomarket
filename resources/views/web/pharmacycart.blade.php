                  ...
                  <tbody >
                     ...
                     <tr>
                        <th scope="row ycart_th">
                           <br>
                           <img src="<?php echo $productdetails->product_image?>" class="ycart_img">
                        ...
                        <td><i class="fas fa-trash ycart_trash" onclick="pharmacyremovecartitem({{ $cartitem->cart_id}})"></i></td>
                     </tr>
                     <?php }else{?> 
                        <tr>
                        <th scope="row ycart_th">
...
<script>
   ...
   function pharmacyremovecartitem(cartid)
    {
      debugger;
         $.ajaxSetup({
                     headers: {
