  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      ...
      @if (count($errors) > 0)
        ...
        <a class="btn btn-success m-auto" style="float: right;" href="{{route('pharmacycoupon')}}">{{ __('messages.Add_Coupon')}}</a>
    </div>
    <div class="card-body">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">{{__('messages.Delete_coupon')}}</h5>
			...
			<div class="modal-footer">
				...
				<a href="{{route('parceldeletecoupon', $coupons->coupon_id)}}" class="btn btn-primary">{{__('messages.Delete')}}</a>
			</div>
		</div>
	</div>
</div>
