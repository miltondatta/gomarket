        	...
        	<div class="modal-dialog" role="document">
        		<div class="modal-content">
        			...
        			<div class="container"> <br> 
                       ...
                       <a href="{{route('pharmacy_sel_product', $lists->ord_id)}}"  class="btn btn-primary pull-center">Accept Order</a><br>
                     </div>  
 ...
 <div class="modal fade" id="exampleModal2{{$lists->ord_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        	<div class="modal-dialog" role="document">
        		<div class="modal-content">
        			...
        			<!--//form-->
        		<form class="forms-sample" action="{{route('pharmacy_rejectorder', $lists->ord_id)}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
        			<div class="row">
