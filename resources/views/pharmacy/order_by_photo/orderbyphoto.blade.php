...
@section ('content')
 <div class="container-fluid">
         ...
         <form class="forms-sample" action="{{route('pharmacy_added_product')}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <select class='fstdropdown-select' style="max-height: 500px;" multiple="multiple" id="eightieth" data-opened="true" name="prod[]">
                          ...
                          <option value="{{$product->variant_id}}">{{$product->product_name}}({{$product->quantity}}{{$product->unit}})</option>
                          @endforeach
                        </select>
             ...
             <div class="col-md-7">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <form class="forms-sample" action="{{route('parmacy_checkout', $u->ord_id)}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                     ...
                     <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th style="width:33.33%">{{ __('messages.Product_Name')}}</th>
                    ...
                    <tr>
                        ...
                        <td class="td-actions text-right">
                           <a href="{{route('pharmacy_delete_product', $sel->l_cid)}}" rel="tooltip" class="btn btn-danger">
                                <i class="material-icons">{{ __('messages.Close')}}</i>
                            </a>
                        </td>
                    </tr>
                      @php $i++; @endphp
