...
<div class="col-md-3"></div>
		 <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> {{ __('messages.Add')}} {{ __('messages.City')}}</h4>
                 ...
                 @endif
                    @if($mapset->mapbox == 0 && $mapset->google_map == 1)
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="autocomplete" name="city_name" placeholder="{{ __('messages.Enter')}} {{ __('messages.Address')}}">
                   ...
                   <div class="form-group">
                    ...
                    <!--</div>-->
                 <div class="form-group">
                      <label>{{ __('messages.City_Image')}}</label>
