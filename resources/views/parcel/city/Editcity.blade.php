		 ...
		 <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{url('parcel/update-city')}}/{{$city->city_id}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                     @if (count($errors) > 0)
                    @if($errors->any())
                 ...
                 @endif
                   ...
                   <div class="form-group">
                      ...
                      <input type="hidden" name="city_image" value="{{$city->city_name}}">
