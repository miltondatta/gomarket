...
Route::group(['namespace'=>'Admin', 'prefix'=>'admin'],function(){
  ...
  Route::get('/checklogin', 'LoginController@checkGetLogin')->name('check-get-login');
...
//logo 
 ...
 // for cityadmin
     ...
     Route::get('delete_user/{id}','UsermanageContoller@delete_user')->name('delete_user');
...
Route::group(['prefix'=>'api','namespace'=>'Api'],function(){
   ...
   // store
    ...
    //delivery boy
     ...
     Route::post('verifyotpfirebase_driver', 'DriverloginController@verifyotpfirebase_driver');
     Route::post('resend_otp_driver', 'DriverloginController@resend_otp_driver');
    ...
    Route::post('pharmacy_deleteaddon', 'Pharmacy_VendorProductController@pharmacy_deleteaddon');
       ...
       Route::post('pharmacy_today_order_count', 'PharmacyDriverOrderController@pharmacy_today_order_count');
        ...
        Route::post('cancel_order_parcel', 'ParcelDetailController@cancel_order_parcel');
        ...
        Route::post('parcel_complete_history', 'ParcelVendorController@parcel_complete_history');
        Route::post('parcel_store_order', 'ParcelVendorController@parcel_store_order');
        Route::post('parcel_today_order', 'ParcelVendorController@parcel_today_order');
        Route::post('parcel_next_day_order', 'ParcelVendorController@parcel_next_day_order');
