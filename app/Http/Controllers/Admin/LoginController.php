...
class LoginController extends Controller
{
    ...
    // Creating this function to show an error instead of an exception
    public function checkGetLogin(){
        return redirect()->route('login')->withErrors('Enter your credentials to continue');
    }
