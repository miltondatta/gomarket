    ...
    $g = DB::table('map_API')
    	 ...
    	 $currency= DB::table('currency')
          ...
          $currency_sign= DB::table('payment_currency')
                ->get();
	 return view('admin.editadmin.editadmin',compact("admin_email","admin_id","admin","delivery_timing","user_api_key","dboy_api_key","api_key","logo","msg91","twilio", "smsby","g","m","mset","currency","country","country_code","number_limit","api_key1","setting","currency_sign","pay","vendor_app_key"));
}
