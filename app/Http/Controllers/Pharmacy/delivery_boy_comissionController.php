...
class delivery_boy_comissionController extends Controller
{
    ...
    public function pharmacydelivery_boy_comission(Request $request)
    {
    	if(Session::has('vendor_pharma'))
          {
    	         ...
    	         return view('pharmacy.deliveryboy_comission.comission',compact("vendor_email","vendor","orders"));
          }
        else
             {
    ...
    public function pharmacyallexceldownload(Request $request)
    {
      ...
      if(Session::has('vendor_pharma'))
      {
         ...
         $export_file->exportExcel('report', $orders_array, false, 'DBOY_COMMISIONS_REPORT');
    ...
    public function pharmacysearchdeliveryboy(Request $request)
    {
...
public function pharmacyexceldownload($startdate,$enddate)
{
  $vendor_email=Session::get('vendor_pharma');
$vendor=DB::table('vendor')
->where('vendor_email',$vendor_email)
