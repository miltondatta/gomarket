...
class AddonController extends Controller
{
    public function addon(Request $request)
    {
        ...
        $product= DB::table('restaurant_addons')
                 ->where('product_id', $id)
                ->get();
        return view('pharmacy.product.addon.show_addon',compact("vendor_email","product","vendor","id"));
    }
     ...
     public function Addproductaddon(Request $request)
    {
       ...
       $vendor_email=Session::get('vendor_pharma');
        ...
        $product= DB::table('restaurant_addons')
         ...
         return view('pharmacy.product.addon.addaddon',compact("vendor_email","vendor","id"));
    }
    ...
    public function Editproductaddon(Request $request)
    {
       ...
       $addon_id=$request->id;
        ...
        $p= DB::table('resturant_product')
    	 ...
    	 return view('pharmacy.product.addon.Editaddon',compact("vendor_email","vendor","product","addon_id"));
   }
