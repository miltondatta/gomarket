    	...
    	if(Session::has('vendor_restaurant'))
          {
    	         ...
    	         return view('resturant.oder_incentive.comission',compact("vendor_email","vendor","orders"));
          }
        else
             {
    ...
    public function resturantallexcelgenerator(Request $request)
    {
      ...
      if(Session::has('vendor_restaurant'))
      {
             ...
             $vendor_email=Session::get('vendor_restaurant');
                ...
                $vendor=DB::table('vendor_restaurant')
                ->where('vendor_email',$vendor_email)
                ->first();
            $orders= DB::table('comission')
    	...
    	if(Session::has('vendor_restaurant'))
          {
    	 	...
    	 	return redirect()->back()->withErrors('Request Send to Admin');
    	         ...
    	         return view('resturant.oder_incentive.comission',compact("vendor_email","orders"));
          }
        else
             {
                return redirect()->route('vendorlogin')->withErrors('please login first');
