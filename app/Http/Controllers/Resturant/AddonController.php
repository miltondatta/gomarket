     ...
     public function Addproductaddon(Request $request)
    {
       ...
       $vendor_email=Session::get('vendor_restaurant');
        ...
        $product= DB::table('restaurant_addons')
         ...
         return view('resturant.product.addon.addaddon',compact("vendor_email","vendor","id"));
    }
    ...
    public function Editproductaddon(Request $request)
    {
       ...
       $addon_id=$request->id;
        ...
        $p= DB::table('resturant_product')
    	 ...
    	 return view('resturant.product.addon.Editaddon',compact("vendor_email","vendor","product","addon_id"));
   }
