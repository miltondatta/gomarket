...
class subcatController extends Controller
{
        ...
        public function vendorAddNewsubcat(Request $request)
    {
        ...
        $insert = DB::table('subcat')
                  ->insert(['category_id'=>$category_name,'subcat_name'=>$subcat_name,'subcat_image'=>'null','created_at'=>$created_at]);
    ...
    public function vendorUpdatesubcat(Request $request)
    {
        ...
        $update = DB::table('subcat')
                 ->where('subcat_id', $subcat_id)
                 ->update(['category_id'=>$category_name,'subcat_name'=>$subcat_name, 'subcat_image'=>'null','updated_at'=>$updated_at]);
