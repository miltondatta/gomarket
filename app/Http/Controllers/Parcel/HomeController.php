    ...
    public function vendorIndex(Request $request)
     ...
     if(Session::has('vendor_parcel'))
     {
        ...
        $current2 = date('d-m-Y', strtotime($current.' + '.$day.' days'));
    	 ...
    	 $total_earnings = DB::table('orders')->where('vendor_id',$vendor->vendor_id)->where('order_status','=','Confirmed')->count(); 
        ...
        return view('parcel.index', compact("vendor_id","vendor_email", "vendor", "total_earnings", "total_users", "ongoing","complete","cityadmin","orders","user","comment","cancel","total_cash","currency","app_share","daily_count","today","recent_order","reffer_arning","created_at"));
