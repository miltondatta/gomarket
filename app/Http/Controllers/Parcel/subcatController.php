...
class subcatController extends Controller
{
    public function resturantsubcat(Request $request)
    {
        ...
        ->paginate(10);
        return view('parcel.subcat.subcat',compact("vendor_email","subcat","vendor"));
    }
     ...
     public function resturantaddsubcat(Request $request)
    {
        ...
        $category= DB::table('resturant_category')
                ->where('vendor_id',$vendor->vendor_id)
                ->get();
         return view('parcel.subcat.addsubcat',compact("vendor_email","category","vendor"));
    }
    ...
    public function resturantEditsubcat(Request $request)
    {
       ...
       $subcat_id=$request->subcat_id;
    	 ...
    	 $category=DB::table('tbl_category')
    	        ->where('vendor_id',$vendor->vendor_id)
                ->get();		  
    	 return view('parcel.subcat.Editsubcat',compact("vendor_email","vendor","category","subcat_id","subcat"));
