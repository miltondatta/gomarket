...
{
    public function parcelcouponlist(Request $request)
    {
         ...
         $coupon= DB::table('coupon')
                ...
                ->get();
        return view('parcel.coupon.couponlist',compact("vendor","coupon","vendor_email"));
    }
    
     public function parcelcoupon(Request $request)
    {
        ...
        $coupon= DB::table('coupon')
                ->get();
        return view('parcel.coupon.couponadd',compact("vendor","coupon","vendor_email"));
    }
    
    
    public function parceladdcoupon(Request $request)
    {
    ...
    public function parceleditcoupon(Request $request)
    {
    	...
    	$vendor_email=Session::get('vendor_parcel');
    	 ...
    	 $coupon= DB::table('coupon')
    	 		  ...
    	 		  ->first();
    	 return view('parcel.coupon.couponedit',compact("vendor","coupon","vendor_email"));


    }
    public function parcelupdatecoupon(Request $request)
    {
       if(Setting::valActDeMode()) return redirect()->back()->withErrors(trans('messages.Active_Demo_Mode'));
        if(Session::has('vendor_parcel'))
     {
  ...
  public function parceldeletecoupon(Request $request)
    {
        if(Setting::valActDeMode()) return redirect()->back()->withErrors(trans('messages.Active_Demo_Mode'));
        $coupon_id=$request->coupon_id;
