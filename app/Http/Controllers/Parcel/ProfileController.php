...
class ProfileController extends Controller
{
    public function resturantProfile(Request $request)
    {
     ...
     if(Session::has('vendor_parcel'))
     {
    	 ...
    	 $profile= DB::table('vendor')
           ...
           return view('parcel.profile',compact("vendor_email","profile"));
    }
	else
	 {
    ...
    public function resturantEditvendor(Request $request)
    {
         ...
         return view('parcel.editvendor.editvendor',compact("vendor_email","vendor_id","vendor"));
    }
    ...
    public function resturantvendorUpdateProfile(Request $request)
    {
     ...
     if(Session::has('vendor_parcel'))
     {
        ...
        if($vendorChangeProfile){
             ...
             session::put('vendor_parcel',$vendor_email);
     ...
     if(Session::has('vendor_parcel'))
     {
        ...
        $vendor_email=Session::get('vendor_parcel');
         $pass= DB::table('vendor')
           ...
           return view('parcel.change_pass',compact("vendor_email","pass"));
    }
	else
	 {
	    return redirect()->route('parcelogin')->withErrors('please login first');
   ...
   public function resturantvendorChangePassword(Request $request)
    {
     ...
     public function resturantvendorLogout(Request $request)
     {
           ...
           return redirect()->route('parcelogin')->withSuccess('Logout Successfully');
     }
}
