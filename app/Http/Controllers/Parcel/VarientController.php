...
class VarientController extends Controller
{
    public function varient(Request $request)
    {
        ...
        $productvarient= DB::table('resturant_variant')
                 ->where('product_id', $id)
                ->get();
        return view('parcel.product.varient.show_varient',compact("vendor_email","productvarient","vendor","id"));
    }
     ...
     public function Addproductvariant(Request $request)
    {
       ...
       $vendor_email=Session::get('vendor_parcel');
        ...
        $product= DB::table('resturant_variant')
         ...
         return view('parcel.product.varient.addvarient',compact("vendor_email","vendor","id"));
    }
    ...
    public function Editproductvariant(Request $request)
    {
       ...
       $variant_id=$request->id;
        ...
        $p= DB::table('resturant_product')
    	 ...
    	 return view('parcel.product.varient.Editvarient',compact("vendor_email","vendor","product","variant_id"));
   }
