  ...
  public function deletevendor(Request $request)
        ...
        public function vendorsecretlogin(Request $request)
    {
    	...
    	if($checkcityadminLogin){
           if($ui_type==1){
            session::put('vendor_grocery',$checkcityadminLogin->vendor_email); 
            return redirect()->route('vendor-index');
           }
           elseif($ui_type==2){
            session::put('vendor_restaurant',$checkcityadminLogin->vendor_email);  
            return redirect()->route('resturant-index');  
           }
           elseif($ui_type==3){
            session::put('vendor_pharma',$checkcityadminLogin->vendor_email);
            return redirect()->route('pharmacy-index');  
           }
           elseif($ui_type==4){
            session::put('vendor_parcel',$checkcityadminLogin->vendor_email);
